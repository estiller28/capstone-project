<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <div class="text-center fs-4 mb-4">Register</div>
        <form method="POST" action="{{ route('register') }}">
            @csrf

            <div>
                <x-jet-label for="barangay" value="{{ __('Barangay Name') }}" />
                <x-jet-input id="barangay" class="block mt-1 w-full" type="text" name="barangay_name" :value="old('barangay_name')" required autofocus autocomplete="barangay_name" />
            </div>
